// Penner easing functions refactored by Charlotte Gore 
// ( https://github.com/CharlotteGore ) to take a 
// single normalised linear time value of between 0 and 1, 
// returning a normalised eased time value.
